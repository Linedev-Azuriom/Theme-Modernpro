                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="user-info border rounded mt-4 d-flex flex-column align-items-center p-3">
                            ...
                            <img src="https://cravatar.eu/avatar/{{ $name }}/100" alt="{{ $name }}"
                        ...
                        <div class="bans collapse show" id="bans" data-bs-parent=".parent">
                            <table class="table table-striped table-hover mt-4">
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <th scope="col"
                                        class="d-lg-table-cell">{{ trans('litebans::messages.reason') }}</th>
                                    <th scope="col">{{ trans('messages.fields.date') }}</th>
                                    <th scope="col"
                                        class="d-lg-table-cell">{{ trans('litebans::messages.expires_at') }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7"
                                            class="text-center">{{ trans('litebans::messages.no_punishments_found') }}
                                        </td>
                                    </tr>
                                @endforelse
                                </tbody>
